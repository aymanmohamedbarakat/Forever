...
//   useEffect(() => {
//     const tempData = [];
//     // إذا كان cartItems يحتوي على هيكل مشابه للخرائط
...
//                 </button>
//               </div>
//               <p>Price: {productData.price * item.quantity}</p>
//             </div>
//           );
//         })}
//       </div>
...
// //             return (
// //               <div key={`${item._id}-${item.size}-${index}`} className="py-4 border-b">
// //                 <div className="flex items-center gap-6">
// //                   <img src={product.image[0]} alt={product.name} className="w-20 h-20" />
// //                   <div>
// //                     <h3>{product.name}</h3>
// //                     <p>Size: {item.size}</p>
