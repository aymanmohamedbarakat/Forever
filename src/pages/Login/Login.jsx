...
import { toast } from "react-toastify"; // إذا لم تكن قد قمت بإضافتها
...
//       }
//     } else if (currentState === "Admin") {
//       // For admin login demonstration purposes
//       success = await login(values.phone, values.password);
//       if (success && isAdmin()) {
//         navigate("/admin");
//       } else {
...
//         }}
//         validationSchema={
//           currentState === "Sign Up" ? RegisterSchema : LoginSchema
//         }
//         onSubmit={handleSubmit}
//       >
//         {({ errors, touched, isSubmitting }) => (
...
//                   type="button"
//                   onClick={() => setCurrentState("Admin")}
//                   className="bg-gray-700 text-white font-light px-8 py-2"
//                 >
//                   Admin Login
//                 </button>
//               )}
